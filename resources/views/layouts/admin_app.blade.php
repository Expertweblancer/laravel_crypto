              ...
              <ul class="list-unstyled components" id="accordion">
                <div class="user-profile">
                  <div class="dropdown user-pro-body">
                    ...
                    <div class="mb-2"><a href="#" class="" data-toggle="" aria-haspopup="true" aria-expanded="false"> <span class="font-weight-semibold">  {{ Auth::guard('admin')->user()->name }}</span>  </a>
                ...
                <li class="">
                  <a href="#Apps" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
                    <i class="fa fa-user-o mr-2"></i> Users
                  </a>
                ...
                <li>
                  <a href=" " class=" wave-effect"><i class="fa fa-map-marker mr-2"></i>Map</a>
                </li>
              </ul>
            </nav>
              @yield('content')
